...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Recepciones</h1>
...
<div class="card shadow mb-4">
    ...
    <a type="button" class="btn btn-success" href="{{ route('receptions.create') }}">Agregar Recepción</a>
            ...
            <table class="table table-bordered" id="tablaUser" width="100%" cellspacing="0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                <form method="POST" action="{{ route('receptions.destroy',$reception) }}">
                                    @csrf
                                    @method('DELETE')
