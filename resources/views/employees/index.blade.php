...
<div class="card shadow mb-4">
    ...
    <a type="button" class="btn btn-success" href='{{ route('employees.create') }}'">Agregar un Empleado</a>
            ...
            <table class="table table-bordered" id="tablaUser" width="100%" cellspacing="0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td> <form action="{{ route('employees.destroy',$employee) }}" method="POST">
                                <a type="button" href="{{route('employees.edit', $employee)}}" class="btn btn-info">Editar</a>
                                @csrf
                                @method('DELETE')
