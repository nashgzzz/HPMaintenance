    ...
    <h2>Agregar Voucher Nuevo</h2>
        ...
        @csrf
                    <div class="form-row">
                        ...
                        <input value="{{old('Hora_llegada')}}" type="time" class="form-control" id="Hora_llegada" name="Hora_llegada" placeholder="Hora_llegada">
                        @error('Hora_llegada')
                            <span> {{$message}} </span>
                        @enderror
                        </div>
                        ...
                        <input value="{{old('Hora_salida')}}" type="time" class="form-control" id="Hora_salida" name="Hora_salida" placeholder="Hora_salida">
                        @error('Hora_salida')
                            <span> {{$message}} </span>
                        @enderror
                        </div>
                        ...
                        <input value="{{old('product_client_vouchers')}}" type="int" class="form-control" id="product_client_vouchers" name="product_client_vouchers" placeholder="product_client_vouchers">
